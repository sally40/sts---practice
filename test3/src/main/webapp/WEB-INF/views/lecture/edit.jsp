...
<div class="container">
  <form:form method="post" modelAttribute="lecture">
    <div class="title">수업 ${ lecture.id > 0 ? "수정" : "등록" }</div>
    <table>
      <tr>
        <td>년도:</td>
      ...
      <tr>
        <td>강의명:</td>
        <td><form:select path="courseId"
                         itemLabel="courseName" itemValue="id" items="${ courses }" />
      </tr>
      <tr>
        <td>분반:</td>
    ...
    <div>
      ...
      <a href="delete?id=${lecture.id}" class="btn" 
